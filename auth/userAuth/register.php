...
if (empty($name))  msg("Please enter your name", 403);
...
if (empty($phone)) msg("Please enter your phone", 403);
elseif (!is_numeric($phone)) msg("Phone must contain only numbers", 403);
elseif (strlen($phone) != 11) msg("Phone must be exactly 11 digits", 403);
